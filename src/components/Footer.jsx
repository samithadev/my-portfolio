...
function Footer() {
  return (
    <div id="footer" className="flex justify-center h-[300px] mx-9 my-6">
      <div className="h-[300px] w-full md:w-[800px] rounded-xl shadow-lg bg-gradient-to-t from-indigo-200 via-purple-200 to-pink-200 background-animate backdrop-blur-3xl p-8">
